let navToggler = document.querySelector(".header-nav__toggler"),
...
function scrollHide() {
  let secondScroll = window.pageYOffset;
...
if (age != undefined) {
  age.forEach(function (selectTag) {
    for (let i = 0; i < 90; i++) {
      let ageOtion = document.createElement("option");
      ageOtion.innerHTML = `${i + 1}`;
